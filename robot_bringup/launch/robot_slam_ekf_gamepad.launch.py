...
def generate_launch_description():
    ...
    robot_slam_launch_file_subpath = 'launch/slam.launch.py'
    EKF_launch_file_subpath = 'launch/robot_localization_EKF.launch.py'
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'rviz_config_file',
            default_value=PathJoinSubstitution([robot_slam_pkg_dir, rviz_config_file_subpath ]),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(robot_localization_pkg_dir, EKF_launch_file_subpath)
            ),
            launch_arguments={'namespace': namespace,
                              'use_TopicBasedSystem_hardware_interface': use_TopicBasedSystem_hardware_interface,
                             }.items()
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(robot_slam_pkg_dir, robot_slam_launch_file_subpath)
            ),
            launch_arguments={'namespace': namespace,
                              'use_sim_time': use_sim_time,
